...
class CongViec(models.Model):
    ...
    khach_hang_id = fields.Many2one('khach_hang', string="Khách hàng", help="Khách hàng liên quan đến công việc")
    bao_gia_id = fields.Many2one('bao_gia', string="Báo giá liên quan")
    lich_hen_id = fields.Many2one('lich_hen', string="Lịch hẹn liên quan")
    tuong_tac_id = fields.Many2one('tuong_tac', string="Tương tác liên quan")
